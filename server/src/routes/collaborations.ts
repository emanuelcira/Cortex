...
// List collaborations for current user (as owner or collaborator)
router.get("/", requireAuth, (req, res) => {
  ...
  // Projects user owns that have collaborators
...
router.get("/:id", requireAuth, (req, res) => {
  ...
  // Only allow owner or collaborator to view
...
router.post("/:id/checkins", requireAuth, (req, res) => {
  ...
  // Verify user is the collaborator or the project owner
...
// Get check-ins for a collaboration
